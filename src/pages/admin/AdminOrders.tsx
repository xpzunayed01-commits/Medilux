    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500">Track and fulfill all incoming customer purchases</p>
        </div>
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
          />
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-gray-200/80 shadow-xs overflow-hidden">
        {filteredOrders.length === 0 ? (
          <div className="text-center py-16 px-4">
            ...
            <p className="text-base font-bold text-gray-800">No matching orders found</p>
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-gray-100">
            ...
            <div className="p-6 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white/95 backdrop-blur-md z-10">
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-base font-bold text-gray-900">Order #{selectedOrder.orderNumber}</span>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="p-4 bg-gray-50 rounded-2xl border border-gray-200/80 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  <p className="text-xs font-bold text-gray-700 uppercase tracking-wider">Change Order Status</p>
                  <p className="text-xs text-gray-500">Updating will immediately reflect across the store</p>
                </div>
                <div className="flex items-center gap-2">
                  <select
                    ...
                    className="px-3 py-2 bg-white border border-gray-300 rounded-xl text-xs font-semibold text-gray-800 focus:ring-2 focus:ring-emerald-500 focus:outline-none"
                  >
              ...
              <div className="border border-gray-100 rounded-2xl p-4 bg-white space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-xs px-2 py-0.5 bg-emerald-50 text-emerald-700 rounded-md font-medium hover:bg-emerald-100"
                  ...
                  <div>
                    <span className="text-xs text-gray-400 block">City / Area</span>
                    ...
                    <div key={idx} className="py-3 flex items-center justify-between gap-3">
                      <div className="flex items-center gap-3">
                        <img
                          ...
                          alt={item.name}
                          className="w-12 h-12 object-cover rounded-xl bg-gray-100 border border-gray-200 shrink-0"
                        />
                        <div>
            ...
            <div className="p-6 border-t border-gray-100 bg-gray-50/50 flex flex-wrap items-center justify-between gap-3 rounded-b-3xl">
              <button
                onClick={() => window.print()}
                className="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-xl text-xs font-semibold hover:bg-gray-100 transition-colors flex items-center gap-1.5"
              >
                <Printer size={15} />
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-4 py-2 text-rose-600 hover:bg-rose-50 rounded-xl text-xs font-semibold transition-colors"
                >
                  Delete
                </button>
                <button
